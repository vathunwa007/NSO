...
<head>
    ...
    <title>เพิ่ม/ลบ/แก้ไข เทมเพล็ต</title>
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">เพิ่ม/แก้ไข เทมเพล็ต</li>
                </ol>

                <!-- Page Content -->
                <h1>เพิ่ม/แก้ไข เทมเพล็ต</h1>
                <hr>
  <div class="input-group" style="margin-top:20px;">
                <span class="">ชื่อรายการ *: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <input type="text" placeholder="Template NameXXX" class="form-control">
            </div>
            <div class="input-group" style="margin-top:20px;">
                <span class="">ชุดข้อมูลสถิติ *: &nbsp;&nbsp;</span>
                <div style="width: 250px;">
                    <select class="form-control" name="location">
                        <option>รายการข้อมูลสิติXXXX</option>

                    </select>
                </div>
            </div>

            <div id="buttondown" style="float: right;bottom:0px;margin:200px auto;">
                <button class="btn btn-secondary" id="sidebarCollapse">บันทึก</button>
                <button class="btn btn-secondary">ล้าง</button>
