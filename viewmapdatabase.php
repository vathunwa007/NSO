...
<head>
    ...
    <title>ข้อมูล Map Database</title>
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">ข้อมูล Map Database</li>
                </ol>

                <!-- Page Content -->
                <h1>ข้อมูล Map Database</h1>
                <hr>
                <div style="width: 100%;">
                <h3>ข้อมูล Map Database</h3>
                <div class="card">
                    <div class="card-body row">
                        <div class="col-6">
                            <h4>Database_Name</h4>
                            <h5>View_Name</h5>
                            <p style="padding-top:20px;">Field_Name_1</p>
                            <p>Field_Name_2</p>
                            <p>Field_Name_3</p>
                            <p>Field_Name_4</p>
                            <p>Field_Name_5</p>
                        ...
                        <div class="col-6 card">
                            ...
                            <div class="card-body">
                                ...
                                <span class="">เลือกรายการข้อมูลที่ต้องการเชื่อมต่อ *: &nbsp;&nbsp;</span>
                                    <div >
                ...
                <button class="btn btn-secondary">สร้าง CSV</button>
                <button class="btn btn-secondary " id="buttonright">บันทึก</button>
                <button class="btn btn-secondary" id="buttonright">ล้างทั้งหมด</button>
                <button class="btn btn-secondary" id="buttonright">ยกเลิก</button>
