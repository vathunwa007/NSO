...
<head>
    ...
    <title>ข้อมูล View Database</title>
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">ข้อมูล View Database</li>
                </ol>

                <!-- Page Content -->
                <h1>ข้อมูล View Database</h1>
                <hr>
                <div style="width: 100%;">
                    <div class="card">
                        <div class="card-body">
                            <h3>Database_Name</h3>
                            <h4 style="margin-left:25px;">View_Name</h4>
                            <p style="margin-left:45px;">Field_Name1</p>
                            <p style="margin-left:45px;">Field_Name2</p>
                            <p style="margin-left:45px;">Field_Name3</p>
                            <p style="margin-left:45px;">Field_Name4</p>
                            <p style="margin-left:45px;">Field_Name5</p>
                            <p style="margin-left:45px;">Field_Name6</p>
                            <p style="margin-left:45px;">Field_Name7</p>
                            <p style="margin-left:45px;">Field_Name8</p>
                            <p style="margin-left:45px;">Field_Name9</p>

                        </div>

                    </div><br>
                    <button class="btn btn-primary" id="buttonright"><img src="https://img.icons8.com/color/25/000000/back.png">Back</button>
