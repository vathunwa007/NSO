...
<head>
    ...
    <title>สร้างการเชื่อมต่อฐานข้อมูลภายนอก</title>
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">สร้างการเชื่อมต่อฐานข้อมูลภายนอก</li>
                </ol>

                <!-- Page Content -->
                <h1>สร้างการเชื่อมต่อฐานข้อมูลภายนอก</h1>
                <hr>
                <div class="col-9 mx-auto"id="centerdiv">
                <div class="input-group" style="margin-top:50px; width:380px;">
                ...
                <div class="input-group" style="margin-top:20px;">
                    ...
                    <div class="input-group" style="width:350px;margin:20px 30px;">
                    ...
                    <div class="input-group">
                        ...
                        <div class="card col-8" style="width: auto;">
                            <div class="card-body">
                        ...
                        <div class="input-group col-8" style="margin-top:25px;">
                ...
                <div style="margin-left:20%;margin-top:20px;">
                    <button class="btn btn-secondary" id="sidebarCollapse">บันทึก</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addCateModalLabel">เพิ่มหมวดหมู่>
