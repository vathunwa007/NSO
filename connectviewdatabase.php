...
<head>
    ...
    <title>เชื่อม View Database</title>
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">เชื่อม View Database</li>
                </ol>

                <!-- Page Content -->
                <h1>เชื่อม View Database</h1>
                <hr>
                <center>
                ...
                <p style="text-align: center;">
                    <button class="btn btn-secondary">Sign View Data</button>
